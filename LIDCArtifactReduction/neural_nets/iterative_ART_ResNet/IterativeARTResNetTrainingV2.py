...
from LIDCArtifactReduction.neural_nets.iterative_ART_ResNet.IterativeARTRestNet_training_loss \
    import RecSinoGradientLoss
from LIDCArtifactReduction.neural_nets.iterative_ART_ResNet.IterativeARTResNetTrainingV1 import RecSinoArrayIterator, \
    RecSinoSuperIterator
...
class IterativeARTResNetTrainingV2(ModelInterface):
    ...
    def _build(self):
        ...
        radon_layer = ForwardRadonLayer(radon_transformation=self._radon_transformation,
                                        name=IterativeARTResNetTrainingV2.sinos_output_name)(target_difference_layer)
    ...
    def _predict_depth_generator_step(self, data_batch):
        actual_reconstructions, bad_sinograms, good_reconstructions = \
            IterativeARTResNetTrainingV2.input_data_decoder(data_batch)
    ...
    def _train_step_2iters(self, data):
        actual_reconstructions_0, bad_sinograms, good_reconstructions = \
            IterativeARTResNetTrainingV2.input_data_decoder(data)
