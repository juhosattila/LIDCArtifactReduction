...
generator = LIDCDataGenerator(verbose=True, batch_size=5, load_data_config=True, shuffle=True,
                              array_stream=RecSinoArrayStream(dir=parameters.TEST_DATA_DIRECTORY))
